...
public class MenuProveedor {public static int menu(Scanner scanner, String tipo) {
...
public static int actualizar(Scanner leer, String tipo) {
	...
	while (true) {
		try {
			...
			System.out.println("4. Fecha elaboracion " + tipo + "s");
			System.out.println("5. Fecha vencimiento ");
			System.out.println("6. Codigo categoría ");
			System.out.println("0. Salir");
			System.out.println();
